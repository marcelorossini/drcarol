...
export default function HomeHero() {
    ...
    return (
        <>
            <div className="flex flex-col items-center gap-8 p-4 pt-12 m-auto w-full relative md:max-w-100 lg:pt-0 lg:absolute lg:max-w-128 xl:max-w-160 lg:top-1/2 lg:-translate-y-1/2 lg:right-12 z-5">
            ...
            <div className="absolute bottom-4 left-4 z-50 flex items-center gap-2 lg:text-2xl text-white">
