    ...
    return (
        <div className="relative">
            ...
            <div className="absolute w-full h-full lg:max-h-120 top-0">
                    <Image src="/assets/carolpg.webp" alt="Dra. Carolina Macedo" fill className="object-contain object-top absolute top-0 left-0 z-10" />
            </div>
            <Page className={`bg-[#121212] ${DEFAULT_PADDING} pt-50 lg:pt-100`} title={<h1 className="text-white">Conheça a <span className="text-primary">Dra. Carolina Macedo</span></h1>}>
                <div className="flex flex-col gap-8 relative">
                <div className="absolute -top-60 z-10 left-0 w-full h-1/4 bg-gradient-to-b from-transparent via-[#121212] via-50% to-[#121212]" />
                    <div className="flex flex-col gap-6 text-lg text-white relative z-10">
                        <p>
                    ...
                    <h1 className="text-primary text-3xl font-caladea">Atualização constante, <br/><span className="text-white">nos maiores eventos e congressos da área</span></h1>
