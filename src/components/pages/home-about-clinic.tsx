        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
                <div className="flex flex-col gap-8">
                    <p className="lg:text-justify">Fundada em 2020 pela Dra. Carolina Macedo, a Clínica nasceu do desejo de proporcionar uma experiência estética humanizada  e acolhedora. <br />
