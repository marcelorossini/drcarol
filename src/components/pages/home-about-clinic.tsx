...
export default function HomeAbout() {
    ...
    return (
        <Page title={<h1 className="text-primary">Nossa Clínica fica em São Paulo, no bairro de Moema</h1>}
            subtitle={<p>Excelente localização, próximo ao aeroporto, ao Shopping Ibirapuera, com total conforto, tanto para brasileiros, quanto para estrangeiros, com atendimento bilíngue (português e inglês).</p>}>
